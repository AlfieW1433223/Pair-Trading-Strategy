...
## Real S&P 500 Sample Run

The project was also run on a 50-stock sample of current S&P 500 constituents using Yahoo Finance adjusted close prices from 2018-01-01 through 2026-08-31. The run used 10 bps transaction costs and selected up to five candidate pairs based on in-sample cointegration tests.
...
This is a more realistic result than the synthetic demo. The simple strategy found relationships that looked attractive in-sample, but those relationships did not hold up out-of-sample after costs. That is a useful research conclusion because it shows why validation matters.
